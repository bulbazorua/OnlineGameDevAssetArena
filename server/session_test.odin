...
@(test)
protocol_version_five_fixtures :: proc(t: ^testing.T) {
    hello: [39]u8
    ...
    testing.expect(t, protocol_encode_welcome(2) == [7]u8{'O', 'G', 'A', 'A', 5, 2, 2})
    ...
    expected := [32]u8{'O', 'G', 'A', 'A', 5, 3, 1, 2, 3, 4, 5, 6, 7, 8, 1, 3, 1, 2, 1, 0, 4, 0, 1, 3, 0, 0, 0, 0, 0, 0, 0, 0}
    ...
    select := [12]u8{'O', 'G', 'A', 'A', 5, 5, 1, 2, 3, 4, 4, 0}
    ...
    ready := [13]u8{'O', 'G', 'A', 'A', 5, 6, 0, 0, 0, 0, 1, 0, 2}
